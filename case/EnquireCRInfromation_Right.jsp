...
%>
    <TR align="center" bgColor=#f8f8f8>
      ...
      <TD align="left" borderColorLight=#3458AC borderColorDark=#3458AC bgcolor="#FFFFFF" ><textarea name=<%=textName1 %> cols="88" rows="3"><%=information %></textarea><input type = "hidden" name = <%=textName %> value =<%=informationID %> /></TD>
    </TR>
<%
        }while(rs.next());
