...
%>
      ...
      <TD align="left" borderColorLight=#3458AC borderColorDark=#3458AC bgcolor="#FFFFFF" ><input name=<%=textName1 %> type="text" size="115" maxlength="200" value=<%=functionPointName %>><input type="hidden" name=<%=textName %> value=<%=functionPointID %>><input type="hidden" name=<%=text_sort_name %> value=<%=sortID %>></TD>
    </TR>
<%
    }while(rs.next());
...
style="BORDER-BOTTOM: #3458AC 0px; BORDER-COLLAPSE: collapse; BORDER-LEFT: #3458AC 0px; BORDER-RIGHT: #3458AC 0px; BORDER-TOP: #3458AC 0px; MARGIN-LEFT: 0pt; " >
  <TBODY>
    ...
    <TR align="center" bgColor=#f8f8f8>
      <TD align="left" borderColorLight=#3458AC borderColorDark=#3458AC bgcolor="#FFFFFF" ><input name="functionpoint" type="text" size="119" maxlength="200"></TD>
    </TR>
  </TBODY>
</TABLE>
<table width="750" border="0" cellspacing="0" cellpadding="0">
