...
%>
                  <td width="163" align="left" valign="top" borderColorLight=#3458AC borderColorDark=#3458AC bgcolor="#74A5E8" ><span class="style5"><textarea name="testarea" cols="20" rows="5" readonly="true" ><%=information %></textarea><input type="hidden" name=<%=CheckName %> value=<%=content %>></span></td>
<%
                  lll++;
                }
                else if(j>0 && i>0){
...
%>
    ...
    <table width=<%=x*175+175 %> border="0" cellspacing="0" cellpadding="0">
      <tbody>
      <tr>
