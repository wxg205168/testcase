...
%>
      <TD align="left" borderColorLight=#3458AC borderColorDark=#3458AC bgcolor="#FFFFFF" ><input name=<%=textName1 %> type="text" size="115" maxlength="200" value=<%=testElementName %>><input type="hidden" name=<%=textName %> value=<%=testElementID %>><input type="hidden" name=<%=text_sort_name %> value=<%=sortID %>></TD>
    </TR>
<%
    }while(rs.next());
