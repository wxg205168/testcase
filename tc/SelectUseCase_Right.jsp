...
%>
      ...
      <TD align="left" borderColorLight=#3458AC borderColorDark=#3458AC bgcolor="#FFFFFF" ><input name=<%=textName1 %> type="text" size="75" maxlength="200" value=<%=UseCaseName %>><input type="hidden" name=<%=textName %> value=<%=UseCaseID %>></TD>
      <TD align="left" borderColorLight=#3458AC borderColorDark=#3458AC bgcolor="#FFFFFF" ><input name=<%=textName2 %> type="text" size="25" maxlength="25" value=<%=UseCaseAB %>><input type="hidden" name=<%=textName %> value=<%=UseCaseID %>></TD>
    </TR>
