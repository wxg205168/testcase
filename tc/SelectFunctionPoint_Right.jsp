...
%>
      ...
      <TD align="left" borderColorLight=#3458AC borderColorDark=#3458AC bgcolor="#FFFFFF" ><input name=<%=textName1 %> type="text" size="102" maxlength="200" value=<%=functionPointName %>><input type="hidden" name=<%=textName %> value=<%=functionPointID %>></TD>
    </TR>
<%
    }while(rs.next());
    rs.close();
