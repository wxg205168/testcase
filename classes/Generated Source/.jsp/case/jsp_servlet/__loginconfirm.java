...
*
* This code was automatically generated at 12:46:01 on 2005-8-29
...
implements weblogic.servlet.jsp.StaleIndicator
{
  ...
  public boolean _isStale() {
    ...
    if (sci.isResourceStale("/LoginConfirm.jsp", 1123571842000L, "8.1.2.0", "Asia/Shanghai")) return true;
    return false;
  }
  ...
  {  
    ...
    try { // error page try block
      ...
      if(rs.next()){ //[ /LoginConfirm.jsp; Line: 30]
        session.setMaxInactiveInterval(1800); //[ /LoginConfirm.jsp; Line: 31]
