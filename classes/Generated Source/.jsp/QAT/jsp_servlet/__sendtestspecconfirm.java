...
*
* This code was automatically generated at 16:28:40 on 2005-8-26
...
implements weblogic.servlet.jsp.StaleIndicator
{
  ...
  public boolean _isStale() {
    ...
    if (sci.isResourceStale("/SendTestSpecConfirm.jsp", 1125044718000L, "8.1.2.0", "Asia/Shanghai")) return true;
    return false;
  }
  ...
  {  
    ...
    try { // error page try block
      ...
      Enumeration ss=session.getAttributeNames(); //[ /SendTestSpecConfirm.jsp; Line: 8]
      //[ /SendTestSpecConfirm.jsp; Line: 9]
      if(!ss.hasMoreElements()){ //[ /SendTestSpecConfirm.jsp; Line: 10]
        _writeText(response, out, _wl_block4, _wl_block4Bytes);
        //[ /SendTestSpecConfirm.jsp; Line: 15]
      } //[ /SendTestSpecConfirm.jsp; Line: 16]
      else{ //[ /SendTestSpecConfirm.jsp; Line: 17]
        _writeText(response, out, _wl_block5, _wl_block5Bytes);
        //[ /SendTestSpecConfirm.jsp; Line: 20]
        String projectName=(String)session.getAttribute("ProjectName"); //[ /SendTestSpecConfirm.jsp; Line: 21]
        String sProjectID=(String)session.getAttribute("ProjectID"); //[ /SendTestSpecConfirm.jsp; Line: 22]
        Date today=new Date(); //[ /SendTestSpecConfirm.jsp; Line: 23]
        //[ /SendTestSpecConfirm.jsp; Line: 24]
        String temp=String.valueOf(today); //[ /SendTestSpecConfirm.jsp; Line: 25]
        //[ /SendTestSpecConfirm.jsp; Line: 26]
        //  Tue Aug 02 15:57:00 CST 2005 //[ /SendTestSpecConfirm.jsp; Line: 27]
        String temp1=temp.substring(4,7); //[ /SendTestSpecConfirm.jsp; Line: 28]
        temp1=temp1+"_"+temp.substring(8,10); //[ /SendTestSpecConfirm.jsp; Line: 29]
        temp1=temp1+"_"+temp.substring(24,28); //[ /SendTestSpecConfirm.jsp; Line: 30]
        //[ /SendTestSpecConfirm.jsp; Line: 31]
        if(!sProjectID.equals("null")){ //[ /SendTestSpecConfirm.jsp; Line: 32]
          //[ /SendTestSpecConfirm.jsp; Line: 33]
          //[ /SendTestSpecConfirm.jsp; Line: 34]
          long projectID=Integer.parseInt(sProjectID); //[ /SendTestSpecConfirm.jsp; Line: 35]
          String fileName="D:\\TestSpecs_"+projectName+"_"+temp1+".xls"; //[ /SendTestSpecConfirm.jsp; Line: 36]
          excel.getExcel(sProjectID,fileName); //[ /SendTestSpecConfirm.jsp; Line: 37]
          session.setAttribute("LoadName",fileName); //[ /SendTestSpecConfirm.jsp; Line: 38]
          //[ /SendTestSpecConfirm.jsp; Line: 39]
        } //[ /SendTestSpecConfirm.jsp; Line: 40]
        _writeText(response, out, _wl_block6, _wl_block6Bytes);
        //[ /SendTestSpecConfirm.jsp; Line: 45]
