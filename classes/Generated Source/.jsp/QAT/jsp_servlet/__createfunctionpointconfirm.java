...
*
* This code was automatically generated at 14:46:32 on 2005-8-10
...
implements weblogic.servlet.jsp.StaleIndicator
{
  ...
  public boolean _isStale() {
    ...
    if (sci.isResourceStale("/CreateFunctionPointConfirm.jsp", 1123654016000L, "8.1.2.0", "Asia/Shanghai")) return true;
    return false;
  }
    ...
    try { // error page try block
      ...
      if(!ss.hasMoreElements()){ //[ /CreateFunctionPointConfirm.jsp; Line: 17]
        ...
        if(sProjectID.equals("null") || sProjectID.equals(null)){ //[ /CreateFunctionPointConfirm.jsp; Line: 42]
          ...
          functionPointName=functionPointName.trim(); //[ /CreateFunctionPointConfirm.jsp; Line: 69]
          //[ /CreateFunctionPointConfirm.jsp; Line: 70]
          //[ /CreateFunctionPointConfirm.jsp; Line: 71]
          if(rr.checkString(functionPointName)){ //[ /CreateFunctionPointConfirm.jsp; Line: 72]
            //[ /CreateFunctionPointConfirm.jsp; Line: 73]
            sql="select fun_n from tctc_function_point where pro_id="+projectID+" and uc_id=" + useCaseID +" and fun_n='"+functionPointName+"'"; //[ /CreateFunctionPointConfirm.jsp; Line: 74]
            rs=myStatement1.executeQuery(sql); //[ /CreateFunctionPointConfirm.jsp; Line: 75]
            //[ /CreateFunctionPointConfirm.jsp; Line: 76]
            if(rs.next()){ //[ /CreateFunctionPointConfirm.jsp; Line: 77]
              session.setAttribute("Error","3.3"); //[ /CreateFunctionPointConfirm.jsp; Line: 78]
              _writeText(response, out, _wl_block8, _wl_block8Bytes);
              //[ /CreateFunctionPointConfirm.jsp; Line: 83]
            } //[ /CreateFunctionPointConfirm.jsp; Line: 84]
            else{ //[ /CreateFunctionPointConfirm.jsp; Line: 85]
              //[ /CreateFunctionPointConfirm.jsp; Line: 86]
              sql="insert into tctc_function_point (fun_p_id,fun_n,pro_id,uc_id) values(seq_tctc_function_point.nextval,'" + functionPointName + "','" + projectID + "','"+useCaseID+"')"; //[ /CreateFunctionPointConfirm.jsp; Line: 87]
              myStatement2.executeUpdate(sql); //[ /CreateFunctionPointConfirm.jsp; Line: 88]
              session.setAttribute("Temp",functionPointName); //[ /CreateFunctionPointConfirm.jsp; Line: 89]
              session.setAttribute("Page","2"); //[ /CreateFunctionPointConfirm.jsp; Line: 90]
              response.sendRedirect("Temp.jsp"); //[ /CreateFunctionPointConfirm.jsp; Line: 91]
            } //[ /CreateFunctionPointConfirm.jsp; Line: 92]
            rs.close(); //[ /CreateFunctionPointConfirm.jsp; Line: 93]
          } //[ /CreateFunctionPointConfirm.jsp; Line: 94]
          else{ //[ /CreateFunctionPointConfirm.jsp; Line: 95]
            session.setAttribute("Error","3.5"); //[ /CreateFunctionPointConfirm.jsp; Line: 96]
            _writeText(response, out, _wl_block9, _wl_block9Bytes);
            //[ /CreateFunctionPointConfirm.jsp; Line: 101]
          } //[ /CreateFunctionPointConfirm.jsp; Line: 102]
        } //[ /CreateFunctionPointConfirm.jsp; Line: 103]
        _writeText(response, out, _wl_block10, _wl_block10Bytes);
        //[ /CreateFunctionPointConfirm.jsp; Line: 105]
        myConn.close(); //[ /CreateFunctionPointConfirm.jsp; Line: 106]
        myStatement1.close(); //[ /CreateFunctionPointConfirm.jsp; Line: 107]
        myStatement2.close(); //[ /CreateFunctionPointConfirm.jsp; Line: 108]
      } //[ /CreateFunctionPointConfirm.jsp; Line: 109]
