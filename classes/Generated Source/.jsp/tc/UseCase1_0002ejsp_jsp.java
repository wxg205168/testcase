...
public class UseCase1_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (session) {
        tt = (mydb.DatabaseBean) pageContext.getAttribute("tt", PageContext.SESSION_SCOPE);
        if (tt == null){
          try {
          ...
          pageContext.setAttribute("tt", tt, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\r\n\r\n");
