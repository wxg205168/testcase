...
*
* This code was automatically generated at 10:00:37 on 2005-8-8
...
implements weblogic.servlet.jsp.StaleIndicator
{
  ...
  public boolean _isStale() {
    ...
    if (sci.isResourceStale("/UpdateTestElementConfirm.jsp", 1123465686000L, "8.1.2.0", "Asia/Shanghai")) return true;
    return false;
  }
  ...
  {  
    ...
    try { // error page try block
      ...
      if(!ss.hasMoreElements()){ //[ /UpdateTestElementConfirm.jsp; Line: 17]
        ...
        //[ /UpdateTestElementConfirm.jsp; Line: 35]
        String sql=new String(); //[ /UpdateTestElementConfirm.jsp; Line: 36]
        ResultSet rs; //[ /UpdateTestElementConfirm.jsp; Line: 37]
        String textName=new String(); //[ /UpdateTestElementConfirm.jsp; Line: 38]
        String textName1=new String(); //[ /UpdateTestElementConfirm.jsp; Line: 39]
        String testElementName=new String(); //[ /UpdateTestElementConfirm.jsp; Line: 40]
        long testElementID=0; //[ /UpdateTestElementConfirm.jsp; Line: 41]
        //[ /UpdateTestElementConfirm.jsp; Line: 42]
        textName="t"+request.getParameter("radiobutton"); //[ /UpdateTestElementConfirm.jsp; Line: 43]
        textName1="u"+request.getParameter("radiobutton"); //[ /UpdateTestElementConfirm.jsp; Line: 44]
        testElementID=Integer.parseInt(request.getParameter(textName)); //[ /UpdateTestElementConfirm.jsp; Line: 45]
        testElementName=(String)request.getParameter(textName1); //[ /UpdateTestElementConfirm.jsp; Line: 46]
        testElementName=rr.replaceString(testElementName); //[ /UpdateTestElementConfirm.jsp; Line: 47]
        testElementName=rr.restore(testElementName); //[ /UpdateTestElementConfirm.jsp; Line: 48]
        //[ /UpdateTestElementConfirm.jsp; Line: 49]
        sql="select * from tctc_element where element_id="+testElementID; //[ /UpdateTestElementConfirm.jsp; Line: 50]
        rs=myStatement1.executeQuery(sql); //[ /UpdateTestElementConfirm.jsp; Line: 51]
        //[ /UpdateTestElementConfirm.jsp; Line: 52]
        if(rs.next()){ //[ /UpdateTestElementConfirm.jsp; Line: 53]
          if(((String)request.getParameter(textName)).equals((String)session.getAttribute("TestElementID"))){ //[ /UpdateTestElementConfirm.jsp; Line: 54]
            session.setAttribute("TestElementName",testElementName); //[ /UpdateTestElementConfirm.jsp; Line: 55]
          } //[ /UpdateTestElementConfirm.jsp; Line: 56]
          //[ /UpdateTestElementConfirm.jsp; Line: 57]
          sql="update tctc_element set element_name='"+testElementName+"' where element_id="+testElementID; //[ /UpdateTestElementConfirm.jsp; Line: 58]
          myStatement2.executeUpdate(sql); //[ /UpdateTestElementConfirm.jsp; Line: 59]
          //[ /UpdateTestElementConfirm.jsp; Line: 60]
        ...
        } //[ /UpdateTestElementConfirm.jsp; Line: 66]
        //[ /UpdateTestElementConfirm.jsp; Line: 67]
        _writeText(response, out, _wl_block6, _wl_block6Bytes);
        //[ /UpdateTestElementConfirm.jsp; Line: 72]
        //[ /UpdateTestElementConfirm.jsp; Line: 73]
        rs.close(); //[ /UpdateTestElementConfirm.jsp; Line: 74]
