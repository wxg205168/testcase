...
*
* This code was automatically generated at 12:42:41 on 2005-8-29
...
implements weblogic.servlet.jsp.StaleIndicator
{
  ...
  public boolean _isStale() {
    ...
    if (sci.isResourceStale("/UpdateUseCaseConfirm.jsp", 1123658392000L, "8.1.2.0", "Asia/Shanghai")) return true;
    return false;
  }
  ...
  {  
    ...
    try { // error page try block
      ...
      if(!ss.hasMoreElements()){ //[ /UpdateUseCaseConfirm.jsp; Line: 19]
        ...
        //[ /UpdateUseCaseConfirm.jsp; Line: 57]
        if(rr.checkString(useCaseAB)){ //[ /UpdateUseCaseConfirm.jsp; Line: 58]
          //[ /UpdateUseCaseConfirm.jsp; Line: 59]
          sql="select uc_id,uc_name from tctc_uc where project_id=" +projectID+" and uc_id="+useCaseID; //[ /UpdateUseCaseConfirm.jsp; Line: 60]
          rs=myStatement1.executeQuery(sql); //[ /UpdateUseCaseConfirm.jsp; Line: 61]
          //[ /UpdateUseCaseConfirm.jsp; Line: 62]
          if(rs.next()){ //[ /UpdateUseCaseConfirm.jsp; Line: 63]
            //[ /UpdateUseCaseConfirm.jsp; Line: 64]
            sql="update tctc_uc set uc_name='"+useCaseName+"', uc_ab='"+useCaseAB+"' where uc_id="+useCaseID; //[ /UpdateUseCaseConfirm.jsp; Line: 65]
            myStatement2.executeUpdate(sql); //[ /UpdateUseCaseConfirm.jsp; Line: 66]
            //[ /UpdateUseCaseConfirm.jsp; Line: 67]
          } //[ /UpdateUseCaseConfirm.jsp; Line: 68]
          else{ //[ /UpdateUseCaseConfirm.jsp; Line: 69]
            session.setAttribute("Error","2.2"); //[ /UpdateUseCaseConfirm.jsp; Line: 70]
          } //[ /UpdateUseCaseConfirm.jsp; Line: 71]
          rs.close(); //[ /UpdateUseCaseConfirm.jsp; Line: 72]
        } //[ /UpdateUseCaseConfirm.jsp; Line: 73]
        else{ //[ /UpdateUseCaseConfirm.jsp; Line: 74]
          session.setAttribute("Error","2.5"); //[ /UpdateUseCaseConfirm.jsp; Line: 75]
        } //[ /UpdateUseCaseConfirm.jsp; Line: 76]
        _writeText(response, out, _wl_block5, _wl_block5Bytes);
        //[ /UpdateUseCaseConfirm.jsp; Line: 83]
        myConn.close(); //[ /UpdateUseCaseConfirm.jsp; Line: 84]
        myStatement1.close(); //[ /UpdateUseCaseConfirm.jsp; Line: 85]
        myStatement2.close(); //[ /UpdateUseCaseConfirm.jsp; Line: 86]
      } //[ /UpdateUseCaseConfirm.jsp; Line: 87]
