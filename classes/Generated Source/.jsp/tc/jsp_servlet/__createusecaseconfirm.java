...
*
* This code was automatically generated at 15:16:30 on 2005-8-9
...
implements weblogic.servlet.jsp.StaleIndicator
{
  ...
  public boolean _isStale() {
    ...
    if (sci.isResourceStale("/CreateUseCaseConfirm.jsp", 1123571788000L, "8.1.2.0", "Asia/Shanghai")) return true;
    return false;
  }
  ...
  {  
    ...
    try { // error page try block
      ...
      if(!ss.hasMoreElements()){ //[ /CreateUseCaseConfirm.jsp; Line: 17]
        ...
        if(rr.checkString(uc_ab)){ //[ /CreateUseCaseConfirm.jsp; Line: 54]
          ...
          if(rs.next()){ //[ /CreateUseCaseConfirm.jsp; Line: 59]
            ...
            //[ /CreateUseCaseConfirm.jsp; Line: 65]
          } //[ /CreateUseCaseConfirm.jsp; Line: 66]
          else{ //[ /CreateUseCaseConfirm.jsp; Line: 67]
            //[ /CreateUseCaseConfirm.jsp; Line: 68]
            sql="insert into tctc_uc (uc_id,uc_name,project_id,uc_ab) values(seq_tctc_uc.nextval,'" + uc_name + "'," + project_id+ ",'"+uc_ab+"')"; //[ /CreateUseCaseConfirm.jsp; Line: 69]
            myStatement2.executeUpdate(sql); //[ /CreateUseCaseConfirm.jsp; Line: 70]
            session.setAttribute("Temp",uc_name); //[ /CreateUseCaseConfirm.jsp; Line: 71]
            session.setAttribute("Page","1"); //[ /CreateUseCaseConfirm.jsp; Line: 72]
            response.sendRedirect("Temp.jsp"); //[ /CreateUseCaseConfirm.jsp; Line: 73]
            //[ /CreateUseCaseConfirm.jsp; Line: 74]
          } //[ /CreateUseCaseConfirm.jsp; Line: 75]
          rs.close(); //[ /CreateUseCaseConfirm.jsp; Line: 76]
        } //[ /CreateUseCaseConfirm.jsp; Line: 77]
        else{ //[ /CreateUseCaseConfirm.jsp; Line: 78]
          session.setAttribute("Error","2.5"); //[ /CreateUseCaseConfirm.jsp; Line: 79]
          _writeText(response, out, _wl_block7, _wl_block7Bytes);
          //[ /CreateUseCaseConfirm.jsp; Line: 84]
        } //[ /CreateUseCaseConfirm.jsp; Line: 85]
        _writeText(response, out, _wl_block8, _wl_block8Bytes);
        //[ /CreateUseCaseConfirm.jsp; Line: 87]
        myConn.close(); //[ /CreateUseCaseConfirm.jsp; Line: 88]
        myStatement1.close(); //[ /CreateUseCaseConfirm.jsp; Line: 89]
        myStatement2.close(); //[ /CreateUseCaseConfirm.jsp; Line: 90]
      } //[ /CreateUseCaseConfirm.jsp; Line: 91]
