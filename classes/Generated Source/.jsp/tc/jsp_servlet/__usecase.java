/* compiled from JSP: /UseCase.jsp
*
* This code was automatically generated at 10:09:16 on 2005-7-20
...
// User imports
import java.sql.*; //[ /UseCase.jsp; Line: 72]
...
implements weblogic.servlet.jsp.StaleIndicator
{
  ...
  public boolean _isStale() {
    ...
    if (sci.isResourceStale("/UseCase.jsp", 1119850928000L, "8.1.2.0", "Asia/Shanghai")) return true;
    return false;
  }
  ...
  {  
    ...
    try { // error page try block
      ...
      mydb.DatabaseBean tt = null; //[ /UseCase.jsp; Line: 73]
      tt = (mydb.DatabaseBean)request.getAttribute("tt"); //[ /UseCase.jsp; Line: 73]
      if (tt == null) { // begin 'tt' instantiation block... //[ /UseCase.jsp; Line: 73]
        { // Don't need to synchronize on request scope //[ /UseCase.jsp; Line: 73]
          tt = (mydb.DatabaseBean)request.getAttribute("tt"); //[ /UseCase.jsp; Line: 73]
          if (tt == null) { // begin 'tt' synchronized instantiation block... //[ /UseCase.jsp; Line: 73]
            tt = new mydb.DatabaseBean(); //[ /UseCase.jsp; Line: 73]
            request.setAttribute("tt", tt); //[ /UseCase.jsp; Line: 73]
          } // end synchronized bean instantiation block... //[ /UseCase.jsp; Line: 73]
        } // end synchronized bean scope block... //[ /UseCase.jsp; Line: 73]
      } // end bean instantiation block... //[ /UseCase.jsp; Line: 73]
      _writeText(response, out, _wl_block2, _wl_block2Bytes);
      //[ /UseCase.jsp; Line: 84]
      //[ /UseCase.jsp; Line: 85]
      String sql=new String(); //[ /UseCase.jsp; Line: 86]
      ResultSet rs; //[ /UseCase.jsp; Line: 87]
      String sError=(String)session.getAttribute("Error"); //[ /UseCase.jsp; Line: 88]
      String dis=new String(); //[ /UseCase.jsp; Line: 89]
      //[ /UseCase.jsp; Line: 90]
      //[ /UseCase.jsp; Line: 91]
      if(sError.equals("2.1") || sError.equals("2.2") || sError.equals("2.3")) //[ /UseCase.jsp; Line: 92]
      { //[ /UseCase.jsp; Line: 93]
        session.setAttribute("Error","null"); //[ /UseCase.jsp; Line: 94]
        sql="select error_dis from tctc_error where error_code='"+sError+"'"; //[ /UseCase.jsp; Line: 95]
        rs=tt.executeQuery(sql); //[ /UseCase.jsp; Line: 96]
        if(rs.next()) //[ /UseCase.jsp; Line: 97]
        { //[ /UseCase.jsp; Line: 98]
          dis=rs.getString("error_dis"); //[ /UseCase.jsp; Line: 99]
          //[ /UseCase.jsp; Line: 100]
          _writeText(response, out, _wl_block3, _wl_block3Bytes);
          out.print(String.valueOf(dis ));  //[ /UseCase.jsp; Line: 102]
          _writeText(response, out, _wl_block4, _wl_block4Bytes);
          //[ /UseCase.jsp; Line: 103]
        } //[ /UseCase.jsp; Line: 104]
      } //[ /UseCase.jsp; Line: 105]
      _writeText(response, out, _wl_block5, _wl_block5Bytes);
      //[ /UseCase.jsp; Line: 118]
      String radioName=new String(); //[ /UseCase.jsp; Line: 119]
      String textName=new String(); //[ /UseCase.jsp; Line: 120]
      String UseCaseName=new String(); //[ /UseCase.jsp; Line: 121]
      int noData=0; //[ /UseCase.jsp; Line: 122]
      //[ /UseCase.jsp; Line: 123]
      String sProjectID=(String)session.getAttribute("ProjectID"); //[ /UseCase.jsp; Line: 124]
      //[ /UseCase.jsp; Line: 125]
      if(sProjectID.equals("null")){ //[ /UseCase.jsp; Line: 126]
        //[ /UseCase.jsp; Line: 127]
        session.setAttribute("Error","2.1"); //[ /UseCase.jsp; Line: 128]
        _writeText(response, out, _wl_block6, _wl_block6Bytes);
        //[ /UseCase.jsp; Line: 136]
        //[ /UseCase.jsp; Line: 137]
      } //[ /UseCase.jsp; Line: 138]
      else{ //[ /UseCase.jsp; Line: 139]
        //[ /UseCase.jsp; Line: 140]
        long projectID=Integer.parseInt(sProjectID); //[ /UseCase.jsp; Line: 141]
        long UseCaseID=0; //[ /UseCase.jsp; Line: 142]
        //[ /UseCase.jsp; Line: 143]
        int number=0; //[ /UseCase.jsp; Line: 144]
        //[ /UseCase.jsp; Line: 145]
        sql="select uc_id,uc_name from tctc_uc where project_id=" +projectID; //[ /UseCase.jsp; Line: 146]
        rs=tt.executeQuery(sql); //[ /UseCase.jsp; Line: 147]
        //[ /UseCase.jsp; Line: 148]
        if(rs.next()){ //[ /UseCase.jsp; Line: 149]
          noData=1; //[ /UseCase.jsp; Line: 150]
          //[ /UseCase.jsp; Line: 151]
          do{ //[ /UseCase.jsp; Line: 152]
            UseCaseID=rs.getLong("uc_id"); //[ /UseCase.jsp; Line: 153]
            UseCaseName=rs.getString("uc_name"); //[ /UseCase.jsp; Line: 154]
            number=number+1; //[ /UseCase.jsp; Line: 155]
            radioName=String.valueOf(number); //[ /UseCase.jsp; Line: 156]
            textName="t"+String.valueOf(number); //[ /UseCase.jsp; Line: 157]
            _writeText(response, out, _wl_block7, _wl_block7Bytes);
            //[ /UseCase.jsp; Line: 160]
            if(number==1){ //[ /UseCase.jsp; Line: 161]
              _writeText(response, out, _wl_block8, _wl_block8Bytes);
              out.print(String.valueOf(radioName ));  //[ /UseCase.jsp; Line: 163]
              _writeText(response, out, _wl_block9, _wl_block9Bytes);
              //[ /UseCase.jsp; Line: 164]
            } //[ /UseCase.jsp; Line: 165]
            else{ //[ /UseCase.jsp; Line: 166]
              _writeText(response, out, _wl_block10, _wl_block10Bytes);
              out.print(String.valueOf(radioName ));  //[ /UseCase.jsp; Line: 168]
              _writeText(response, out, _wl_block11, _wl_block11Bytes);
              //[ /UseCase.jsp; Line: 169]
            } //[ /UseCase.jsp; Line: 170]
            _writeText(response, out, _wl_block12, _wl_block12Bytes);
            out.print(String.valueOf(UseCaseName ));  //[ /UseCase.jsp; Line: 173]
            _writeText(response, out, _wl_block13, _wl_block13Bytes);
            out.print(String.valueOf(textName ));  //[ /UseCase.jsp; Line: 173]
            _writeText(response, out, _wl_block14, _wl_block14Bytes);
            out.print(String.valueOf(UseCaseID ));  //[ /UseCase.jsp; Line: 173]
            _writeText(response, out, _wl_block15, _wl_block15Bytes);
            //[ /UseCase.jsp; Line: 175]
          }while(rs.next()); //[ /UseCase.jsp; Line: 176]
          rs.close(); //[ /UseCase.jsp; Line: 177]
          _writeText(response, out, _wl_block16, _wl_block16Bytes);
          //[ /UseCase.jsp; Line: 180]
        } //[ /UseCase.jsp; Line: 181]
        _writeText(response, out, _wl_block17, _wl_block17Bytes);
        //[ /UseCase.jsp; Line: 183]
      } //[ /UseCase.jsp; Line: 184]
      //[ /UseCase.jsp; Line: 185]
      if(noData==1){ //[ /UseCase.jsp; Line: 186]
        //[ /UseCase.jsp; Line: 187]
        _writeText(response, out, _wl_block18, _wl_block18Bytes);
        //[ /UseCase.jsp; Line: 195]
      } //[ /UseCase.jsp; Line: 196]
      _writeText(response, out, _wl_block19, _wl_block19Bytes);
      out.print(String.valueOf(session.getAttribute("ProjectName") ));  //[ /UseCase.jsp; Line: 280]
      _writeText(response, out, _wl_block20, _wl_block20Bytes);
      out.print(String.valueOf(session.getAttribute("UseCaseName") ));  //[ /UseCase.jsp; Line: 281]
      _writeText(response, out, _wl_block21, _wl_block21Bytes);
      out.print(String.valueOf(session.getAttribute("FunctionPointName") ));  //[ /UseCase.jsp; Line: 282]
      _writeText(response, out, _wl_block22, _wl_block22Bytes);
      out.print(String.valueOf(session.getAttribute("TestElementName") ));  //[ /UseCase.jsp; Line: 283]
