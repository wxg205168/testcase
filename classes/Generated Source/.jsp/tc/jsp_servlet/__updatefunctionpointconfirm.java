...
*
* This code was automatically generated at 10:00:33 on 2005-8-8
...
implements weblogic.servlet.jsp.StaleIndicator
{
  ...
  public boolean _isStale() {
    ...
    if (sci.isResourceStale("/UpdateFunctionPointConfirm.jsp", 1123466102000L, "8.1.2.0", "Asia/Shanghai")) return true;
    return false;
  }
  ...
  {  
    ...
    try { // error page try block
      ...
      if(!ss.hasMoreElements()){ //[ /UpdateFunctionPointConfirm.jsp; Line: 17]
        ...
        //[ /UpdateFunctionPointConfirm.jsp; Line: 35]
        String sql=new String(); //[ /UpdateFunctionPointConfirm.jsp; Line: 36]
        ResultSet rs; //[ /UpdateFunctionPointConfirm.jsp; Line: 37]
        String textName=new String(); //[ /UpdateFunctionPointConfirm.jsp; Line: 38]
        String textName1=new String(); //[ /UpdateFunctionPointConfirm.jsp; Line: 39]
        String functionPointName=new String(); //[ /UpdateFunctionPointConfirm.jsp; Line: 40]
        long functionPointID=0; //[ /UpdateFunctionPointConfirm.jsp; Line: 41]
        //[ /UpdateFunctionPointConfirm.jsp; Line: 42]
        textName="t"+request.getParameter("radiobutton"); //[ /UpdateFunctionPointConfirm.jsp; Line: 43]
        textName1="u"+request.getParameter("radiobutton"); //[ /UpdateFunctionPointConfirm.jsp; Line: 44]
        functionPointID=Integer.parseInt(request.getParameter(textName)); //[ /UpdateFunctionPointConfirm.jsp; Line: 45]
        functionPointName=(String)request.getParameter(textName1); //[ /UpdateFunctionPointConfirm.jsp; Line: 46]
        functionPointName=rr.replaceString(functionPointName); //[ /UpdateFunctionPointConfirm.jsp; Line: 47]
        functionPointName=rr.restore(functionPointName); //[ /UpdateFunctionPointConfirm.jsp; Line: 48]
        //[ /UpdateFunctionPointConfirm.jsp; Line: 49]
        ...
        } //[ /UpdateFunctionPointConfirm.jsp; Line: 62]
        else //[ /UpdateFunctionPointConfirm.jsp; Line: 63]
        { //[ /UpdateFunctionPointConfirm.jsp; Line: 64]
          session.setAttribute("Error","3.2"); //[ /UpdateFunctionPointConfirm.jsp; Line: 65]
          //[ /UpdateFunctionPointConfirm.jsp; Line: 66]
        } //[ /UpdateFunctionPointConfirm.jsp; Line: 67]
        //[ /UpdateFunctionPointConfirm.jsp; Line: 68]
        _writeText(response, out, _wl_block6, _wl_block6Bytes);
        //[ /UpdateFunctionPointConfirm.jsp; Line: 73]
        //[ /UpdateFunctionPointConfirm.jsp; Line: 74]
        rs.close(); //[ /UpdateFunctionPointConfirm.jsp; Line: 75]
        _writeText(response, out, _wl_block7, _wl_block7Bytes);
        //[ /UpdateFunctionPointConfirm.jsp; Line: 77]
        myConn.close(); //[ /UpdateFunctionPointConfirm.jsp; Line: 78]
        myStatement1.close(); //[ /UpdateFunctionPointConfirm.jsp; Line: 79]
        myStatement2.close(); //[ /UpdateFunctionPointConfirm.jsp; Line: 80]
      } //[ /UpdateFunctionPointConfirm.jsp; Line: 81]
