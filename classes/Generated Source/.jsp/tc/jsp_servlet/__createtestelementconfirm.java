...
*
* This code was automatically generated at 9:59:56 on 2005-8-8
...
implements weblogic.servlet.jsp.StaleIndicator
{
  ...
  public boolean _isStale() {
    ...
    if (sci.isResourceStale("/CreateTestElementConfirm.jsp", 1123465726000L, "8.1.2.0", "Asia/Shanghai")) return true;
    return false;
  }
  ...
  {  
    ...
    try { // error page try block
      ...
      if(!ss.hasMoreElements()){ //[ /CreateTestElementConfirm.jsp; Line: 17]
        ...
        testElementName=rr.restore(testElementName); //[ /CreateTestElementConfirm.jsp; Line: 53]
        testElementName=testElementName.trim(); //[ /CreateTestElementConfirm.jsp; Line: 54]
        //[ /CreateTestElementConfirm.jsp; Line: 55]
        sql="select element_id,element_name from tctc_element where project_id=" +projectID+" and uc_id="+useCaseID + " and functionpoint_id="+functionPointID+" and element_name='"+testElementName+"'";; //[ /CreateTestElementConfirm.jsp; Line: 56]
        rs=myStatement1.executeQuery(sql); //[ /CreateTestElementConfirm.jsp; Line: 57]
        //[ /CreateTestElementConfirm.jsp; Line: 58]
        if(rs.next()){ //[ /CreateTestElementConfirm.jsp; Line: 59]
          session.setAttribute("Error","4.3"); //[ /CreateTestElementConfirm.jsp; Line: 60]
          _writeText(response, out, _wl_block6, _wl_block6Bytes);
          //[ /CreateTestElementConfirm.jsp; Line: 65]
        } //[ /CreateTestElementConfirm.jsp; Line: 66]
        else{ //[ /CreateTestElementConfirm.jsp; Line: 67]
          //[ /CreateTestElementConfirm.jsp; Line: 68]
          sql="insert into tctc_element (element_id,element_name,project_id,uc_id,functionpoint_id) values(seq_tctc_element.nextval,'" + testElementName + "','" + projectID + "','"+useCaseID+"','"+functionPointID+"')"; //[ /CreateTestElementConfirm.jsp; Line: 69]
          myStatement2.executeUpdate(sql); //[ /CreateTestElementConfirm.jsp; Line: 70]
          session.setAttribute("Temp",testElementName); //[ /CreateTestElementConfirm.jsp; Line: 71]
          session.setAttribute("Page","3"); //[ /CreateTestElementConfirm.jsp; Line: 72]
          response.sendRedirect("Temp.jsp"); //[ /CreateTestElementConfirm.jsp; Line: 73]
        } //[ /CreateTestElementConfirm.jsp; Line: 74]
        rs.close(); //[ /CreateTestElementConfirm.jsp; Line: 75]
        _writeText(response, out, _wl_block7, _wl_block7Bytes);
        //[ /CreateTestElementConfirm.jsp; Line: 77]
        myConn.close(); //[ /CreateTestElementConfirm.jsp; Line: 78]
        myStatement1.close(); //[ /CreateTestElementConfirm.jsp; Line: 79]
        myStatement2.close(); //[ /CreateTestElementConfirm.jsp; Line: 80]
      } //[ /CreateTestElementConfirm.jsp; Line: 81]
