...
*
* This code was automatically generated at 9:12:04 on 2005-8-8
...
/**
* This code was automatically generated at 9:12:05 on 2005-8-8
* by weblogic.servlet.jsp.Jsp2Java -- do not edit.
*
...
implements weblogic.servlet.jsp.StaleIndicator
{
  ...
  public boolean _isStale() {
    ...
    if (sci.isResourceStale("/CreateCRInformationConfirm.jsp", 1123463520000L, "8.1.2.0", "Asia/Shanghai")) return true;
    return false;
  }
          ...
          { //[ /CreateCRInformationConfirm.jsp; Line: 82]
            ...
            if(dis==null){ //[ /CreateCRInformationConfirm.jsp; Line: 99]
              ...
              if (rs.next()){ //[ /CreateCRInformationConfirm.jsp; Line: 112]
                ...
                if(MaterialType.equals("1")){ //[ /CreateCRInformationConfirm.jsp; Line: 123]
                  sql="insert into tctc_information (inf_id,inf_type,inf_dis,fun_p_id,project_id,uc_id,element_id) values(seq_tctc_information.nextval,'" + type + "','" + dis + "','" + functionPointID + "','"+projectID+"','"+useCaseID+"','"+testElementID+"')"; //[ /CreateCRInformationConfirm.jsp; Line: 124]
                } //[ /CreateCRInformationConfirm.jsp; Line: 125]
                else if(MaterialType.equals("2")){ //[ /CreateCRInformationConfirm.jsp; Line: 126]
                  sql="insert into tctc_information (inf_id,inf_type,inf_dis,fun_p_id,project_id,uc_id) values(seq_tctc_information.nextval,'" + type + "','" + dis + "','" + functionPointID + "','"+projectID+"','"+useCaseID+"')"; //[ /CreateCRInformationConfirm.jsp; Line: 127]
                } //[ /CreateCRInformationConfirm.jsp; Line: 128]
                //[ /CreateCRInformationConfirm.jsp; Line: 129]
                myStatement2.executeUpdate(sql); //[ /CreateCRInformationConfirm.jsp; Line: 130]
                rs.close(); //[ /CreateCRInformationConfirm.jsp; Line: 131]
                session.setAttribute("Type",type); //[ /CreateCRInformationConfirm.jsp; Line: 132]
                _writeText(response, out, _wl_block11, _wl_block11Bytes);
                //[ /CreateCRInformationConfirm.jsp; Line: 137]
                //[ /CreateCRInformationConfirm.jsp; Line: 138]
              } //[ /CreateCRInformationConfirm.jsp; Line: 139]
            } //[ /CreateCRInformationConfirm.jsp; Line: 140]
          } //[ /CreateCRInformationConfirm.jsp; Line: 141]
          else //[ /CreateCRInformationConfirm.jsp; Line: 142]
          { //[ /CreateCRInformationConfirm.jsp; Line: 143]
            session.setAttribute("Error","5.1"); //[ /CreateCRInformationConfirm.jsp; Line: 144]
            //[ /CreateCRInformationConfirm.jsp; Line: 145]
            _writeText(response, out, _wl_block12, _wl_block12Bytes);
            //[ /CreateCRInformationConfirm.jsp; Line: 150]
          } //[ /CreateCRInformationConfirm.jsp; Line: 151]
        } //[ /CreateCRInformationConfirm.jsp; Line: 152]
        _writeText(response, out, _wl_block13, _wl_block13Bytes);
        //[ /CreateCRInformationConfirm.jsp; Line: 154]
        myConn.close(); //[ /CreateCRInformationConfirm.jsp; Line: 155]
        myStatement1.close(); //[ /CreateCRInformationConfirm.jsp; Line: 156]
        myStatement2.close(); //[ /CreateCRInformationConfirm.jsp; Line: 157]
