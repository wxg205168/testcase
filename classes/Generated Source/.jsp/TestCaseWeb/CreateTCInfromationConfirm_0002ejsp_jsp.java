...
public class CreateTCInfromationConfirm_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</script>\r\n\r\n");
      out.write("<body>\r\n");
      out.write("<form method=\"post\" action=\"CreateTCInfromation.jsp\">\r\n");
      out.write("\r\n");
      ...
      out.write("<p>\r\n        ");
      out.write("<label>");
      out.write("<span class=\"style1\">Test Case Material ");
      out.write("</span>");
      out.write("</label>\r\n      ");
      out.write("</p>\r\n\r\n");
  ...
  String dis= request.getParameter("content");
  ...
  if (rs.next()){
    ...
    if(MaterialType.equals("1")){
      sql="insert into tctc_information (inf_type,inf_dis,fun_p_id,project_id,uc_id,element_id) values('" + type + "','" + dis + "','" + FunctionPointID + "','"+ProjectID+"','"+UseCaseID+"','"+TestElementID+"')";
    }
    else if(MaterialType.equals("2")){
      sql="insert into tctc_information (inf_type,inf_dis,fun_p_id,project_id,uc_id) values('" + type + "','" + dis + "','" + FunctionPointID + "','"+ProjectID+"','"+UseCaseID+"')";
    }
    tt.executeQuery(sql);
    rs.close();
    session.setAttribute("Type",type);
      ...
      out.write("<span class=\"style1\">Type:");
      out.write("</span>");
      out.write("</td>\r\n          ");
      ...
      out.write("<tr>\r\n          ");
      out.write("<td>");
      out.write("<span class=\"style1\">Content:");
      out.write("</span>");
      out.write("</td>\r\n          ");
      out.write("<td>");
      out.write("<textarea name=\"textarea\" cols=\"70\" rows=\"5\" readonly=\"true\">");
      out.print(dis );
      out.write("</textarea>");
      out.write("</td>\r\n        ");
      out.write("</tr>\r\n      ");
      ...
      out.write("</p>\r\n      ");
      out.write("<p>\r\n        ");
      out.write("<input type=\"submit\" name=\"Submit\" value=\"Add New Material\" />\r\n      ");
      out.write("</p>\r\n");
  ...
  else
  {
      ...
      out.write("\r\n   ");
      out.write("<h1>\r\n     ");
      out.write("<font size=\"5\">\r\n     Please select the test element firstly.\r\n     ");
      out.write("</font>\r\n   ");
      out.write("</h1>\r\n\r\n");
