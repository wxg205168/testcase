...
public class DeleteFunctionPointConfirm_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Delete FunctionPoint Confirm");
      out.write("</title>\r\n");
      ...
      out.write("</script>\r\n\r\n");
      out.write("<body>\r\n");
      out.write("<form method=\"post\" action=\"DeleteFunctionPoint.jsp\">\r\n  ");
      out.write("\r\n ");
  ...
  sql="select * from tctc_function_point where fun_p_id="+textValue2;
  ...
  if(rs.next()){
    sql="delete from tctc_function_point where fun_p_id="+textValue2;
    tt.executeQuery(sql);

    if(textValue2.equals((String)session.getAttribute("FunctionPointID"))){
      ...
      out.write("</p>\r\n\t  ");
      out.write("<p>\r\n        ");
      out.write("<input type=\"submit\" name=\"Submit\" value=\"Delete Other FunctionPoint\" />\r\n      ");
      out.write("</p>\r\n");
