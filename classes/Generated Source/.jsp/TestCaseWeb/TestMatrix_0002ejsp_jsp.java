...
public class TestMatrix_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Test Case Matrix");
      out.write("</title>\r\n");
      ...
      out.write("</script>\r\n\r\n");
      out.write("<body>\r\n\r\n");
      out.write("<form method=\"post\" action=\"TestMatrixConfirm.jsp\">\r\n\r\n");
      out.write("\r\n");
  ...
  if(!sFunctionPointID.equals("null"))
  {
  ...
  session.setAttribute("C_Number",String.valueOf(y));
      ...
      out.write("\r\n\r\n");
      out.write("<table width=\"304\" height=\"167\" border=\"1\">\r\n");
  ...
  sql="select inf_dis from tctc_information where inf_type='r' and fun_p_id=" + functionPointID;
  rs2=tt.executeQuery(sql);
  rs2.next();
  ...
  for(int i=0;i<(y+1);i++)
  {
    ...
    for(int j=0;j<(x+1);j++)
    {
      ...
      out.print(CheckName );
      out.write(" cols=\"20\" rows=\"5\" readonly=\"true\">");
      out.print(content );
      out.write("</textarea>");
      out.write("</td>\r\n\r\n");
