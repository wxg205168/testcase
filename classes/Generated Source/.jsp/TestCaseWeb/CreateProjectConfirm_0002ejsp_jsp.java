...
public class CreateProjectConfirm_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</script>\r\n\r\n");
      out.write("<body>\r\n");
      out.write("<form method=\"post\" action=\"CreateProject.jsp\">\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      mydb.DatabaseBean tt1 = null;
      synchronized (pageContext) {
        tt1 = (mydb.DatabaseBean) pageContext.getAttribute("tt1", PageContext.PAGE_SCOPE);
        if (tt1 == null){
          try {
            tt1 = (mydb.DatabaseBean) java.beans.Beans.instantiate(this.getClass().getClassLoader(), "mydb.DatabaseBean");
          } catch (ClassNotFoundException exc) {
            throw new InstantiationException(exc.getMessage());
          } catch (Exception exc) {
            throw new ServletException("Cannot create bean of class " + "mydb.DatabaseBean", exc);
          }
          pageContext.setAttribute("tt1", tt1, PageContext.PAGE_SCOPE);
        }
      }
      out.write("\r\n\r\n");
      ...
      out.write("<p>\r\n        ");
      out.write("<label>");
      out.write("<span class=\"style1\">Project Information:");
      out.write("</span>");
      out.write("</label>\r\n      ");
      out.write("</p>\r\n");

  String sql=new String();
  String projectName=new String(request.getParameter("projectName"));
  String projectManager=new String(request.getParameter("projectManager"));
  String projectLeader=new String(request.getParameter("projectLeader"));
  ResultSet rs,rs1;

  sql="select * from tctc_project where pro_n='"+projectName+"'";
  ...
  if(rs.next()){
    ...
    sql="insert into tctc_project (pro_n,pro_m,pro_l) values('"+projectName+"','"+projectManager+"','"+projectLeader+"')";
    tt.executeQuery(sql);

      out.write("\r\n      ");
      out.write("<table width=\"600\" border=\"1\">\r\n        ");
      out.write("<tr>\r\n          ");
      out.write("<td width=\"150\" class=\"style1\">Project Name: ");
      out.write("</td>\r\n          ");
      ...
      out.write("</tr>\r\n        ");
      out.write("<tr>\r\n          ");
      out.write("<td class=\"style1\">Project Manager: ");
      out.write("</td>\r\n          ");
      out.write("<td>");
      out.write("<span class=\"style8\">");
      ...
      out.write("</tr>\r\n        ");
      out.write("<tr>\r\n          ");
      out.write("<td class=\"style1\">Project Leader: ");
      out.write("</td>\r\n          ");
      out.write("<td>");
      out.write("<span class=\"style8\">");
      ...
      out.write("</p>\r\n\t  ");
      out.write("<p>\r\n        ");
      out.write("<input type=\"submit\" name=\"Submit\" value=\"Add New Project\" />\r\n");
      out.write("</p>\r\n\r\n\r\n");


    sql="select pro_id from tctc_project where pro_n='"+projectName+"'";
    rs1=tt1.executeQuery(sql);
    long projectID=0;
