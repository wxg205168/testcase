...
public class UpdateCRInfromationConfirm_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</script>\r\n\r\n");
      out.write("<body>\r\n");
      out.write("<form method=\"post\" action=\"UpdateCRInfromation.jsp\">\r\n ");
      out.write("\r\n");
  ...
  for(int i=1;i<(number+1);i++){
    ...
    infDis=request.getParameter(textName);
    ...
    if(infDis!=null){
      hidResult=request.getParameter(hidName);
      sql="update tctc_information set inf_dis = '" + infDis + "' where inf_id="+Integer.parseInt(hidResult);
      tt.executeQuery(sql);
    }
  }
      ...
      out.write("</p>\r\n      ");
      out.write("<p>\r\n        ");
      out.write("<input type=\"submit\" name=\"Submit\" value=\"Update Other Material\" />\r\n      ");
      out.write("</p>\r\n      ");
      out.write("<p>&nbsp;");
      out.write("</p>\r\n      ");
      out.write("<p>&nbsp;      ");
