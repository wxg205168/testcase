...
public class DeleteTestElementConfirm_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Delete TestElement Confirm");
      out.write("</title>\r\n");
      ...
      out.write("</script>\r\n\r\n");
      out.write("<body>\r\n");
      out.write("<form method=\"post\" action=\"DeleteTestElement.jsp\">\r\n  ");
      out.write("\r\n ");
  ...
  sql="select * from tctc_element where element_id="+textValue2;
  ...
  if(rs.next()){
    sql="delete from tctc_element where element_id="+textValue2;
    tt.executeQuery(sql);

    if(textValue2.equals((String)session.getAttribute("TestElementID"))){
      ...
      out.write("</p>\r\n\t  ");
      out.write("<p>\r\n        ");
      out.write("<input type=\"submit\" name=\"Submit\" value=\"Delete Other TestElement\" />\r\n      ");
      out.write("</p>\r\n");
