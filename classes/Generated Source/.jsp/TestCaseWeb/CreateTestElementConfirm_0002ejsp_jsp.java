...
public class CreateTestElementConfirm_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</script>\r\n\r\n");
      out.write("<body>\r\n");
      out.write("<form method=\"post\" action=\"CreateTestElement.jsp\">\r\n");
      out.write("\r\n");
      ...
      out.write("<p>\r\n        ");
      out.write("<label>");
      out.write("<span class=\"style1\">TestElement Information:");
      out.write("</span>");
      out.write("</label>\r\n      ");
      out.write("</p>\r\n");

  String selectname = new String();
  String selectname1 = new String();
  String selectname2 = new String();
  String testelement_name = new String();
  long project_id = 0;
  long usecase_id = 0;
  long functionpoint_id=0;
  String sql;
  ResultSet rs;
  selectname=(String)session.getAttribute("ProjectID");
  selectname1=(String)session.getAttribute("UseCaseID");
  selectname2=(String)session.getAttribute("FunctionPointID");
  testelement_name=request.getParameter("testelementName");

  if(selectname.equals("null") || selectname1.equals("null") || selectname2.equals("null")){
  ...
  usecase_id=Integer.parseInt(selectname1);
  functionpoint_id=Integer.parseInt(selectname2);

  sql="select * from tctc_element where project_id="+project_id+" and uc_id=" + usecase_id +" and functionpoint_id=" + functionpoint_id + " and element_name='"+testelement_name+"'";
  ...
  if(rs.next()){
    ...
    sql="insert into tctc_element (element_name,project_id,uc_id,functionpoint_id) values('" + testelement_name + "','" + project_id + "','"+usecase_id+"','"+functionpoint_id+"')";
    tt.executeQuery(sql);
      ...
      out.write("<span class=\"style1\">TestElement  Name:");
      out.write("</span>");
      out.write("</td>\r\n          ");
      out.write("<td width=\"400\" class=\"style8\">");
      out.print(testelement_name );
      out.write("</td>\r\n        ");
      out.write("</tr>\r\n      ");
      out.write("</table>\r\n      ");
      out.write("<p>&nbsp;");
      out.write("</p>\r\n\t  ");
      out.write("<p>\r\n        ");
      out.write("<input type=\"submit\" name=\"Submit\" value=\"Add New TestElement\" />\r\n      ");
      out.write("</p>\r\n\r\n");

    sql="select element_id from tctc_element where element_name='"+testelement_name+"'";
    rs=tt.executeQuery(sql);
    long elementID=0;
    ...
    if(rs.next())
    {
      ...
      session.setAttribute("TestElementName",testelement_name);
      session.setAttribute("TestElementID",String.valueOf(elementID));
