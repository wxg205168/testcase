...
public class TestMatrixConfirm_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Test Case Confirm");
      out.write("</title>\r\n");
  ...
  for(int i=1;i<(y+1);i++){
    ...
    if(write)
    {
      sql="insert into tctc_test_case (condition,result,fun_p_id,pro_id,uc_id) values('" + cContent + "','" + rContent + "','" + Integer.parseInt(funID) + "','" + Integer.parseInt(projectID) + "','"+Integer.parseInt(sUCID)+"')";
      tt.executeQuery(sql);
    }
  }
