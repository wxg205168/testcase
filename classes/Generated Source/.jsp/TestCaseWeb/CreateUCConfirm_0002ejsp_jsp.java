...
public class CreateUCConfirm_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</script>\r\n\r\n");
      out.write("<body>\r\n");
      out.write("<form method=\"post\" action=\"CreateUseCase.jsp\">\r\n");
      out.write("\r\n");
  ...
  uc_name=request.getParameter("UCName");

  if(selectname.equals("null")){
  ...
  if(rs.next()){
    ...
    sql="insert into tctc_uc (uc_name,project_id) values('" + uc_name + "'," + project_id+")";
    tt.executeQuery(sql);
      ...
      out.write("<span class=\"style1\">UseCase");
      out.write("</span> Name: ");
      out.write("</td>\r\n          ");
      ...
      out.write("</p>\r\n\t  ");
      out.write("<p>\r\n        ");
      out.write("<input type=\"submit\" name=\"Submit\" value=\"Add New UseCase\" />\r\n      ");
      out.write("</p>\r\n\r\n");

    sql="select uc_id from tctc_uc where uc_name='"+uc_name+"'";
    rs=tt.executeQuery(sql);
    long ucID=0;
    ...
    if(rs.next())
    {
      ...
      ucID=rs.getLong("uc_id");
      session.setAttribute("UseCaseName",uc_name);
      session.setAttribute("UseCaseID",String.valueOf(ucID));
