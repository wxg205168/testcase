...
public class CreateConditionConfirm_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Create Condition Confirm");
      out.write("</title>\r\n");
      ...
      out.write("</script>\r\n\r\n");
      out.write("<body>\r\n\r\n");
      out.write("<form method=\"post\" action=\"CreateCondition.jsp\">\r\n");
      out.write("\r\n");
  ...
  String sNumber=(String)session.getAttribute("CR_Number");
  ...
  for(int i=1;i<number;i++)
  {
    ...
    hideName="H"+checkValue+checkName;
    sInformationID=request.getParameter(hideName);

    informationID=Integer.parseInt(sInformationID);

    sql="select inf_dis from tctc_information where inf_id="+informationID;
    rs1=tt.executeQuery(sql);
    if(rs1.next())
    {
      condition=rs1.getString("inf_dis");
      content=content+"\n"+condition;
    }
  ...
  {
    sql="insert into tctc_information (inf_type,inf_dis,fun_p_id,project_id,uc_id) values('condition','" + content + "','" + functionPointID + "','"+projectID+"','"+useCaseID+"')";
    tt.executeQuery(sql);
      ...
      out.write("</font>\r\n\r\n  ");
      out.write("<p>\r\n   ");
      out.write("<input type=\"submit\" name=\"Submit\" value=\"Add New Test Condition\" />\r\n  ");
      out.write("</p>\r\n\r\n      ");
      out.write("<p>&nbsp;");
      out.write("</p>\r\n      ");
      out.write("<p>&nbsp;");
