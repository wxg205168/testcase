...
public class CreateFunctionPointConfirm_0002ejsp_jsp extends HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Create FunctionPoint Confirm");
      out.write("</title>\r\n");
      ...
      out.write("</script>\r\n\r\n");
      out.write("<body>\r\n");
      out.write("<form method=\"post\" action=\"CreateFunctionPoint.jsp\">\r\n");
      out.write("\r\n");
  ...
  String function_point_name = new String();
  String function_point_remark = new String();
  long project_id = 0;
  long usecase_id = 0;
  String sql;
  ResultSet rs;
  ...
  function_point_name=request.getParameter("functionPointName");
  function_point_remark=request.getParameter("remark");

  if(selectname.equals("null") || selectname1.equals("null")){

      out.write("\r\n   ");
      out.write("<h1>\r\n     ");
      out.write("<font size=\"5\">\r\n     Please select the project or ucse case firstly.\r\n     ");
      out.write("</font>\r\n   ");
      out.write("</h1>\r\n\r\n");
  ...
  sql="select * from tctc_function_point where pro_id="+project_id+" and uc_id=" + usecase_id +" and fun_n='"+function_point_name+"'";
  ...
  if(rs.next()){
    ...
    sql="insert into tctc_function_point (fun_n,fun_r,pro_id,uc_id) values('" + function_point_name + "','" + function_point_remark + "','" + project_id + "','"+usecase_id+"')";
    ...
    tt.executeQuery(sql);
      ...
      out.write("<span class=\"style1\">FunctionPoint");
      out.write("</span> Name: ");
      out.write("</td>\r\n          ");
      out.write("<td width=\"400\" class=\"style8\">");
      out.print(function_point_name );
      out.write("</td>\r\n        ");
      out.write("</tr>\r\n        ");
      out.write("<tr>\r\n          ");
      ...
      out.print(function_point_remark );
      out.write("</td>\r\n        ");
      out.write("</tr>\r\n      ");
      out.write("</table>\r\n      ");
      out.write("<p>&nbsp;");
      out.write("</p>\r\n\t  ");
      out.write("<p>\r\n        ");
      out.write("<input type=\"submit\" name=\"Submit\" value=\"Add New FunctionPoint\" />\r\n      ");
      out.write("</p>\r\n\r\n");

    sql="select fun_id from tctc_function_point where fun_n='"+function_point_name+"'";
    rs=tt.executeQuery(sql);
    ...
    if(rs.next())
    {
      ...
      functionPointID=rs.getLong("fun_id");
      session.setAttribute("FunctionPointName",function_point_name);
